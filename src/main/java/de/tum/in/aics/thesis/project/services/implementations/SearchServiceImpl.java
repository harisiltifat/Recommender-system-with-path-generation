...
public class SearchServiceImpl  implements ISearchService {
	...
	public List<Place> search(Location loc1, Location loc2) {
		...
		midloc = Utilities.midPoint(loc1, loc2);
		
		int dist = (int) Math.ceil(Utilities.distance(midloc, loc1, 'K') * 1000);
		...
		Utilities.mergeList(allPlaces, lstPlace3);
